    ...
    <div class="row g-4">
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">Full Stack Development</h3>
      ...
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">AI / Gen AI</h3>
          <div class="d-flex flex-wrap gap-2">
      ...
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">Cloud & DevOps</h3>
          <div class="d-flex flex-wrap gap-2">
      ...
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">Databases</h3>
          <div class="d-flex flex-wrap gap-2">
      ...
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">Analytics & Marketing</h3>
          <div class="d-flex flex-wrap gap-2">
      ...
      <div class="col-md-6">
        <div class="card h-100 border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">Software Tools Used</h3>
          <div class="d-flex flex-wrap gap-2">
      ...
      <div class="col-12">
        <div class="card border-0 shadow-sm p-3">
          <h3 class="h5 mb-3 text-white">AI Tools Used</h3>
          <div class="d-flex flex-wrap gap-2">
