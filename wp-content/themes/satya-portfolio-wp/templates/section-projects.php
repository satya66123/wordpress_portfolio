...
<section id="projects" class="py-5 projects-section" aria-labelledby="projects-heading">
  <div class="container">
      ...
      <?php foreach ( $projects as $category => $items ) : ?>
        <div class="col-md-6">
          <div class="card h-100 text-white overflow-hidden" style="background: rgba(255,255,255,0.04); backdrop-filter: blur(6px);">
            <div class="card-body">
              <h3 class="h5 text-white mb-3"><?php echo esc_html( $category ); ?></h3>
              <ul class="mb-0">
                <?php foreach ( $items as $project ) : ?>
                  <li class="mb-3">
                    <strong><?php echo esc_html( $project['name'] ); ?></strong>
				  </br>
                    <span class="badge rounded-pill py-2 px-3 bg-dark text-white"><?php echo esc_html( $project['tech'] ); ?></span>
                  </li>
                <?php endforeach; ?>
              </ul>
            </div>
